...
# LINKED IN THE README FROM THE GITHUB REPO.
...
picked=c()
# HOW MANY UNIQUE SNPS WE WILL CALCULATE (INITIATE VARIABLE-COUNTER)
total=0
# IN HOW MANY CASES ANY SNP FROM THE CREDIBLE SET IS ALSO THE TOP PVALUE SNP (INITIATE VARIABLE-COUNTER)
count=0
...
# SPECIFY HERE THE DATASET THAT YOU WANT TO ANALYZE
cla="all_624_pv_lmi" 
nosig=aa[aa$P >= 1e-4,]
